...
bool playVideo = true; // play, pause, close and restart function
float N1 = 50.0; // Quatization parameter for foreground
float N2 = 1.0; // Quantization parameter for background
